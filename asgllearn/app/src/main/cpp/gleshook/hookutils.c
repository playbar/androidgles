...
JNIEXPORT void JNICALL Java_com_android_hook_GLESHook_initHook(JNIEnv* env, jobject obj)
{
    LOGI("initHook begin");
    hookGLESFun();
//    hookThreadFun();
...
JNIEXPORT void JNICALL Java_com_android_hook_GLESHook_hookTest(JNIEnv* env, jobject obj)
{

}

JNIEXPORT void JNICALL Java_com_android_hook_GLESHook_unInitHook(JNIEnv* env, jobject obj)
{
    unhookAllFun();
}
