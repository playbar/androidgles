...
extern "C"{
	...
	jstring		Java_com_baofeng_mojing_MojingTextureBaker_MojingTextureBaker_stringFromJNI(JNIEnv* env, jobject thiz);
	// 		函数功能：开始图片合批工作
	...
	// 		iX ，iY ，iWidth ，iHeight 分别用来指定被合批的字图像在iTextureID中的范围，以像素为单位。如果iX iY iWidth iHeight均为0，表示删除所有iTextureID指定的图像。
